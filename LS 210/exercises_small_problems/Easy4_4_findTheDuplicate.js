...
// Rules: -one value from array is duplicate
//        -other values occur only one
// Algorithm:
// -sort elements
// -set current elements
// -iterate through elements
// -if element is equal to current element than return element

function findDup(array) {
  return array.sort(function(el1, el2) {return el1 - el2}).filter(function(n, i) {
      return array[i-1] === n
  })[0];
}
