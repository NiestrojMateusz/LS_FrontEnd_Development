// In the previous exercise, the function returns the count of instances of the word in the text. This is useful. 
// However, there are also times when we just want to find the word in the context of the text. For this exercise, 
// write a function that takes a word and text as input and returns the text with the word highlighted. To highlight a 
// word, enclose the word with two asterisks ** and have it be in all uppercase letters (i.e. **HIGHLIGHTEDWORD**).

// Example:

function searchWord(word, text) {
  var searched = new RegExp(word,"gi");
  var replacer = `**${word.toUpperCase()}**`
  return text.replace(searched, replacer )
}
